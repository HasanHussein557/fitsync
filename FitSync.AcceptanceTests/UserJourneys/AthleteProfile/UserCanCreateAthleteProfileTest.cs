...
{
    public class UserCanCreateAthleteProfileTest : IClassFixture<TestWebApplicationFactory>
    {
        private readonly HttpClient _client;
        private readonly TestWebApplicationFactory _factory;

        public UserCanCreateAthleteProfileTest(TestWebApplicationFactory factory)
        {
            _factory = factory;
